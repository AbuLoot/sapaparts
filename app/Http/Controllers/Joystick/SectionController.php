...
class SectionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/admin/section')->with('status', 'Запись добавлена!');
    }
    ...
    {    	
        ...
        return redirect('/admin/section')->with('status', 'Запись обновлена!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/admin/section')->with('status', 'Запись удалена!');
    }
}
