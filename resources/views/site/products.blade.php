            ...
            <div class="col-sm-4 col-md-4 col-xs-6">
              <div class="thumbnail">
                ...
                @if(is_array($favorites) AND in_array($product->id, $favorites['products_id']))
                  <button type="button" class="btn btn-like btn-default" id="toggle-favorite" data-favorite-id="{{ $product->id }}"><span class="glyphicon glyphicon-heart text-danger"></span></button>
                @else
